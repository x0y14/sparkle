...
describe("ec-quantity-selector", () => {
  ...
  test("DOM: 初期値 1 表示", async () => {
    ...
    el.setAttribute("value", "1"); el.setAttribute("min", "1"); el.setAttribute("max", "10");
  ...
  test("DOM: + で値増加", async () => {
    await import("../../src/components/ec-quantity-selector.js");
    const el = document.createElement("ec-quantity-selector") as any;
    el.setAttribute("value", "1"); el.setAttribute("max", "10");
    document.body.appendChild(el);
    await flushMicrotasks();
  ...
  test("DOM: − で値減少", async () => {
    await import("../../src/components/ec-quantity-selector.js");
    const el = document.createElement("ec-quantity-selector") as any;
    el.setAttribute("value", "3"); el.setAttribute("min", "1"); el.setAttribute("max", "10");
    document.body.appendChild(el);
    await flushMicrotasks();
  ...
  test("DOM: max 超えない", async () => {
    await import("../../src/components/ec-quantity-selector.js");
    const el = document.createElement("ec-quantity-selector") as any;
    el.setAttribute("value", "3"); el.setAttribute("max", "3");
    document.body.appendChild(el);
    await flushMicrotasks();
    el.shadowRoot!.querySelector("[data-action='increment']").click();
    await flushMicrotasks();
  ...
  test("DOM: min 下回らない", async () => {
    await import("../../src/components/ec-quantity-selector.js");
    const el = document.createElement("ec-quantity-selector") as any;
    el.setAttribute("value", "1"); el.setAttribute("min", "1");
    document.body.appendChild(el);
    await flushMicrotasks();
    el.shadowRoot!.querySelector("[data-action='decrement']").click();
    await flushMicrotasks();
  ...
  test("DOM: max 時に + ボタン disabled", async () => {
    await import("../../src/components/ec-quantity-selector.js");
    const el = document.createElement("ec-quantity-selector") as any;
    el.setAttribute("value", "5"); el.setAttribute("max", "5");
    document.body.appendChild(el);
    await flushMicrotasks();
    expect(el.shadowRoot!.querySelector("[data-action='increment']").hasAttribute("disabled")).toBe(true);
  });
  ...
  test("DOM: min 時に − ボタン disabled", async () => {
    ...
    document.body.appendChild(el);
    await flushMicrotasks();
    expect(el.shadowRoot!.querySelector("[data-action='decrement']").hasAttribute("disabled")).toBe(true);
  });
});
